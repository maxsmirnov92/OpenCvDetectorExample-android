...
public class ObjectDetectorSettings implements IDetectorSettings, Serializable {
	...
	DETECTOR_SENSITIVITY sensitivity = DefaultObjectDetectorSettings.DEFAULT_SENSITIVITY;
	...
	public ObjectDetectorSettings(DETECTOR_SENSITIVITY sensitivity, int frameToDetect, boolean takePhoto, int framesToAnalyze,
