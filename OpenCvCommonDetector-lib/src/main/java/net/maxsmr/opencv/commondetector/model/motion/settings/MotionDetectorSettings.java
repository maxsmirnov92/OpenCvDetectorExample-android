...
public class MotionDetectorSettings implements IDetectorSettings, Serializable {
	...
	DetectorSensivity sensitivity = DefaultMotionDetectorSettings.DEFAULT_SENSITIVITY;
	...
	public MotionDetectorSettings(DetectorSensivity sensitivity, int frameToDetect, boolean takePhoto, int framesToAnalyze,
