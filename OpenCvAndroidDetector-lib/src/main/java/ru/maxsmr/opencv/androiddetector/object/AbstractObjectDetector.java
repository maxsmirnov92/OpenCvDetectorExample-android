...
public abstract class AbstractObjectDetector {
    ...
    public synchronized ObjectDetectVideoInfo detectObjectsInVideoFile(File videoFile, int framesCount, DETECTOR_SENSITIVITY sensitivity,
    ...
    public static List<ObjectDetectVideoInfo> testObjectDetector(AbstractObjectDetector detector, String videosPath, String detectInfoName,
        ...
        if (detector == null) {
            logger.error("what are you going to test, huh? detector is null");
            return null;
        }
